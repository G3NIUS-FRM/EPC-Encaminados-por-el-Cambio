export const ministries = [
  ...
  },
  {
    ...
    equipo: [
      ...
      { nombre: "Viceministra de Relaciones Exteriores", cargo: "Por designar" },
  ...
  },
  {
    ...
    equipo: [
      ...
      { nombre: "Viceministro de Administraciones Públicas", cargo: "Por designar" },
  ...
  },
  {
    ...
    descripcionCompleta:
      "El Ministerio de Deportes, Juventud y Mujer, bajo la conducción de Isaias German, articulará políticas para tres ejes fundamentales: el deporte como herramienta de transformación social, la participación activa de la juventud y la equidad de género.\n\nEl deporte no es solo actividad física: es educación, salud, inclusión y desarrollo. Por eso impulsaremos la construcción y mantenimiento de instalaciones deportivas en cada municipio, el apoyo a atletas de alto rendimiento y los programas de deporte comunitario.\n\nLa juventud necesita oportunidades reales: educación, empleo, participación política y espacios de expresión. Crearemos un sistema nacional de juventud con voz vinculante en las decisiones del Estado. Y en materia de género, trabajaremos por la igualdad sustantiva con políticas de prevención de violencia, autonomía económica y participación política de las mujeres.",
    imagen:
      "https://images.unsplash.com/photo-1461896836936-ffe607ba8211?w=1200&q=80",
    imagenSecundaria:
      "https://images.unsplash.com/photo-1517649763962-0c623066013b?w=1200&q=80",
    metricas: [
      { valor: "1", label: "Centro por municipio" },
      { valor: "50%", label: "Mujeres en cargos" },
      { valor: "100", label: "Atletas becados" },
      { valor: "1M", label: "Jóvenes alcanzados" },
    ],
    propuestas: [
      {
        titulo: "Infraestructura Deportiva",
        descripcion:
          "Construcción y mantenimiento de polideportivos en cada municipio del país, con acceso gratuito para la comunidad y programas de formación.",
      },
      {
        titulo: "Parlamento Juvenil",
        descripcion:
          "Creación del Parlamento Juvenil Nacional con voz vinculante en políticas públicas, elegidos democráticamente por jóvenes de todo el país.",
      },
      {
        titulo: "Equidad de Género",
        descripcion:
          "Políticas transversales para la igualdad de género: prevención de violencia, autonomía económica, paridad en cargos públicos y educación sin estereotipos.",
      },
      {
        titulo: "Becas para Atletas",
        descripcion:
          "Programa nacional de becas para atletas de alto rendimiento, con apoyo económico, formación educativa y acceso a centros de entrenamiento internacional.",
      },
    ],
    equipo: [
    ...
    metas: [
      "Alcanzar paridad de género en cargos públicos",
      "Construir 158 polideportivos municipales",
      "Duplicar el número de atletas federados",
      "Reducir la violencia de género en un 50%",
    ],
    icono: "trophy",
  },
  {
  ...
  },
  {
    ...
    imagenTitular:
      "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=300&h=300&fit=crop&q=80",
    cargo: "Ministro",
    descripcion:
      "Coordinaremos la gestión gubernamental con eficiencia, asegurando que las políticas públicas lleguen de manera efectiva a cada ciudadano y cada rincón del país.",
    descripcionCompleta:
      "El Ministerio Administrativo de la Presidencia, dirigido por Andry Rogelio Piñeiro Chalas, es el brazo articulador del gobierno. Su misión es coordinar la gestión interinstitucional, asegurar la coherencia de las políticas públicas y optimizar el uso de los recursos del Estado.\n\nEsta cartera juega un papel clave en la implementación del plan de gobierno, en el seguimiento de los compromisos presidenciales y en la articulación con los demás ministerios y entidades del Estado. Una gestión eficiente aquí se traduce en mejores servicios para los ciudadanos.\n\nTrabajaremos con transparencia, evaluación constante de resultados y mecanismos de rendición de cuentas. Cada programa y proyecto será monitoreado con indicadores claros y públicos.",
    imagen:
      "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&q=80",
    imagenSecundaria:
      "https://images.unsplash.com/photo-1577962917302-cd874c4e31d2?w=1200&q=80",
    metricas: [
      { valor: "30", label: "Programas prioritarios" },
      { valor: "100%", label: "Transparencia activa" },
      { valor: "Mensual", label: "Rendición de cuentas" },
      { valor: "0", label: "Tolerancia a la corrupción" },
    ],
    propuestas: [
      {
        titulo: "Coordinación Interinstitucional",
        descripcion:
          "Sistema de seguimiento y evaluación de los programas de gobierno, con indicadores claros y publicación periódica de avances.",
      },
      {
        titulo: "Transparencia Total",
        descripcion:
          "Portal de datos abiertos con información presupuestaria, contrataciones, evaluaciones y resultados de cada ministerio.",
      },
      {
        titulo: "Gestión por Resultados",
        descripcion:
          "Implementación del modelo de gestión por resultados en todas las instituciones del Estado, con metas medibles y consecuencias por incumplimiento.",
      },
      {
        titulo: "Rendición de Cuentas",
        descripcion:
          "Informes mensuales públicos de avances del plan de gobierno, con comparecencias periódicas ante la sociedad civil y el Congreso.",
      },
    ],
    equipo: [
    ...
    metas: [
      "Implementar gestión por resultados en el 100% de ministerios",
      "Publicar el 100% de la información presupuestaria",
      "Reducir el tiempo de respuesta gubernamental en un 50%",
      "Cumplir al menos el 80% de las metas anuales del plan de gobierno",
    ],
    icono: "building",
  },
  {
  ...
  },
  {
    ...
    imagenTitular:
      "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=300&h=300&fit=crop&q=80",
    cargo: "Ministra",
    descripcion:
  ...
  },
  {
    ...
    cargo: "Ministra",
    descripcion:
      "Una economía sólida al servicio del pueblo. Administraremos las finanzas públicas con responsabilidad, transparencia y visión de futuro, reduciendo la carga tributaria a las familias.",
    descripcionCompleta:
      "El Ministerio de Hacienda y Economía, bajo la conducción de Heidy Franchesca Moronta Aybar, tiene la responsabilidad de administrar las finanzas públicas con responsabilidad, transparencia y visión de futuro.\n\nUna economía sólida requiere políticas fiscales prudentes, una recaudación justa y un gasto público eficiente. Trabajaremos para reducir la carga tributaria a las familias más vulnerables, simplificar el sistema impositivo y combatir la evasión fiscal.\n\nAdemás, articularemos la política macroeconómica con el plan de desarrollo: política monetaria, fiscal, comercial y de inversión, todo en función del crecimiento inclusivo y la generación de empleos dignos. La estabilidad macroeconómica es condición para el desarrollo.",
    imagen:
      "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80",
    imagenSecundaria:
      "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=1200&q=80",
    metricas: [
      { valor: "5%", label: "Meta de crecimiento" },
      { valor: "60%", label: "Recaudación / PIB" },
      { valor: "-20%", label: "Carga a familias" },
      { valor: "AAA", label: "Calificación crediticia" },
    ],
    propuestas: [
      {
        titulo: "Reforma Tributaria Progresiva",
        descripcion:
          "Reducción de impuestos a las familias de menores ingresos, eliminación de exenciones injustificadas y simplificación del sistema tributario.",
      },
      {
        titulo: "Recaudación Eficiente",
        descripcion:
          "Modernización de la administración tributaria con tecnología, facturación electrónica y combate frontal a la evasión y el contrabando.",
      },
      {
        titulo: "Presupuesto por Resultados",
        descripcion:
          "Reforma del proceso presupuestario para asignar recursos en función de resultados medibles y prioridades del plan de gobierno.",
      },
      {
        titulo: "Deuda Sostenible",
        descripcion:
          "Estrategia de manejo de deuda pública que priorice el financiamiento de proyectos productivos y mantenga la sostenibilidad fiscal.",
      },
    ],
    equipo: [
    ...
    metas: [
      "Alcanzar un crecimiento económico del 5% anual",
      "Aumentar la recaudación al 18% del PIB",
      "Reducir la carga tributaria a las familias en 20%",
      "Mantener la deuda pública por debajo del 60% del PIB",
    ],
    icono: "trendingUp",
  },
];